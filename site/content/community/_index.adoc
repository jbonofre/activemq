...
#
linkTitle: 'Community'
title: 'Apache ActiveMQ Community'
weight: 300
params:
...
[cols="2,3"]
|===
| link:https://the-asf.slack.com/[The ASF Slack]
| Our public chat

| link:https://github.com/apache/activemq[GitHub]
| Development takes place here!

| link:{{% ref "contributing-guidelines" %}}[Contribution Guidelines]
| How to contribute to Apache ActiveMQ
|===
{{% /blocks/feature %}}
...
| mailto:dev-subscribe@activemq.apache.org[Subscribe to dev@]

  link:https://lists.apache.org/list.html?activemq.apache.org[Mailing List Archives,window=_blank]
| Notifications about GitHub issues and PRs
| mailto:issues-subscribe@activemq.apache.org[Subscribe to issues@]

  link:https://lists.apache.org/list.html?activemq.apache.org[Mailing List Archives,window=_blank]
| Notifications about Git commits
| mailto:commits-subscribe@activemq.apache.org[Subscribe to commits@]
